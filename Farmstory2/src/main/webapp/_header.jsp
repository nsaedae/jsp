    ...
    <div id="wrapper">
        <header>
            ...
            <ul class="gnb">
                ...
                <li><a href="/Farmstory2/board/list.do?group=market"><img src="/Farmstory2/img/head_menu_badge.png" alt="30%"/>장보기</a></li>
                <li><a href="/Farmstory2/board/list.do?group=croptalk">농작물이야기</a></li>
                <li><a href="/Farmstory2/board/list.do?group=event">이벤트</a></li>
                <li><a href="/Farmstory2/board/list.do?group=community">커뮤니티</a></li>
            </ul>
        </header>
