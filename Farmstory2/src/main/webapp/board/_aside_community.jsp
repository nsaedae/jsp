...
<div id="sub">
    ...
    <section class="cate5">
        ...
        <article>
            <nav>
                <c:if test="${cate eq 'notice'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit1.png" alt="농작물이야기"/></c:if>
            	<c:if test="${cate eq 'menu'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit2.png" alt="농작물이야기"/></c:if>
            	<c:if test="${cate eq 'chef'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit3.png" alt="농작물이야기"/></c:if>
            	<c:if test="${cate eq 'qna'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit4.png" alt="농작물이야기"/></c:if>
            	<c:if test="${cate eq 'faq'}"><img src="/Farmstory2/img/sub_nav_tit_cate5_tit5.png" alt="농작물이야기"/></c:if>
